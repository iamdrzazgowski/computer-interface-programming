...
bool sendTextFile(){
    ...
    while (fgets(bufferIn, sizeof(bufferIn), file)) {
        cout << bufferIn;
...
int main() {
    //C:\Users\student\Desktop
        ...
        cout << "2. Przeslanie pliku tekstowego" << endl;
        cout << "3. Przeslanie pliku binarnego" << endl;
